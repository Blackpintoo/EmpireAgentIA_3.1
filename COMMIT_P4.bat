...
echo.
echo ==========================================================
echo   P4 : RECONNEXION MT5 + ATTRIBUTS DE STOPS
echo ==========================================================
echo.
...
if exist ".venv\Scripts\python.exe" (
    .venv\Scripts\python.exe -m py_compile utils\mt5_client.py
) else (
...
git diff --stat -- utils/mt5_client.py
echo.
echo       Attendu : environ 51 lignes sur 1 fichier.
echo.
echo       Appuie sur une touche pour commiter, ou ferme pour annuler.
pause >nul
git add -- utils/mt5_client.py
git commit -F "_transfert\msg_p4.txt"
