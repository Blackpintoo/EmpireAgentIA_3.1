@echo off
setlocal
title Deploiement correctifs P1-P6 (v2)

cd /d "%~dp0"

echo.
echo ==========================================================
echo   CORRECTIFS P1 A P6 - BRANCHE fix-audit-p1-p7   (v2)
echo ==========================================================
echo.
echo   ARRETE LE BOT avant de continuer, s'il tourne encore.
echo.
...
echo [3/5] Verification des fichiers de CODE
echo       (data\ et reports\ sont ignores : ce sont des donnees
echo        d'execution, identiques sur les deux branches, git les
echo        conserve telles quelles pendant le basculement)
...
echo.
echo       Tes donnees d'execution (positions, historique, caches)
echo       ne sont pas touchees.
echo.
...
echo.
echo Ceux-la ne sont pas des donnees d'execution. Rien n'a ete
echo modifie. Signale-le a Claude avant de continuer.
goto :fin
