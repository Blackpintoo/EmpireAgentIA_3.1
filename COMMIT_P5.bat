...
echo.
echo ==========================================================
echo   P5 : SHADOW MODE SILENCIEUX
echo ==========================================================
echo.
...
if exist ".venv\Scripts\python.exe" (
    .venv\Scripts\python.exe -m py_compile orchestrator\orchestrator.py
) else (
...
git diff --stat -- orchestrator/orchestrator.py
echo.
echo       Attendu : environ 20 lignes sur 1 fichier.
echo.
echo       Appuie sur une touche pour commiter, ou ferme pour annuler.
pause >nul
git add -- orchestrator/orchestrator.py
git commit -F "_transfert\msg_p5.txt"
