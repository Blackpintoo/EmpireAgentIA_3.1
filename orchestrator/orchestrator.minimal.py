...
class Orchestrator:
    ...
    async def start(self):
        ...
        try:
            ...
            pass
        self.scheduler.add_job(self._orchestrate_once, "interval", seconds=interval_seconds, id=job_id, replace_existing=True)  # FIX 2026-03-05: ajusté pour débloquer trading
